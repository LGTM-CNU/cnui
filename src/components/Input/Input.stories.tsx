...
export const FoucsedColor: InputStory = () => {
  return (
    <div css={wrapper}>
...
export const Error: InputStory = () => {
  return (
    <Input
      placeholder="leehj0110@kakao.com"
      isError
...
export const WithLabel: InputStory = () => {
  return (
    <div css={wrapper}>
      <Input label="Email" placeholder="leehj0110@kakao.com" size="sm" />
      <Input label="Email" placeholder="leehj0110@kakao.com" />
      <Input label="Email" placeholder="leehj0110@kakao.com" size="lg" />
      <Input
        label="Email"
        placeholder="leehj0110@kakao.com"
        isError
